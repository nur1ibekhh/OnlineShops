...
import com.example.newproject180.databinding.ViewholderSizeBinding
   ...
   inner class Viewholder(val binding: ViewholderSizeBinding):
    ...
    override fun onBindViewHolder(holder: SizeListAdapter.Viewholder, position: Int) {
        ...
        if (selectedPosition==position){
            ...
            holder.binding.sizeTxt.setHintTextColor(context.resources.getColor(R.color.white))
        }else{
            holder.binding.sizeLayout.setBackgroundResource(R.drawable.grey_bg)
            holder.binding.sizeTxt.setHintTextColor(context.resources.getColor(R.color.black))
        }
    }
